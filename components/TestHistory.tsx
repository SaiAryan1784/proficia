...
const TestHistory: React.FC<TestHistoryProps> = ({ initialTests = [], totalTests = 0 }) => {
  ...
  }, [hasInitialized, fetchTestHistory, initialTests]);
  ...
  return (
    <div className="bg-card p-6 rounded-lg shadow-sm border border-border">
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-sm text-muted-foreground">({totalTests || tests.length} tests)</span>
      </div>
      ...
      {tests.length === 0 ? (
        <div className="text-center py-12">
          <FaQuestionCircle className="text-4xl text-muted-foreground mx-auto mb-4" />
          <p className="text-muted-foreground">No tests completed yet</p>
          <p className="text-sm text-muted-foreground">Take your first test to see your history here</p>
        </div>
      ) : (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="font-semibold text-foreground">{test.topicName}</h3>
                ...
                {expandedTest === test.id && (
                  ...
                  >
                    <div className="p-4 bg-muted/20">
                      <h4 className="font-medium text-foreground mb-3">Questions & Answers</h4>
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                  ...
                                  {question.userAnswer === question.correctAnswer ? (
                                    ...
                                    <FaTimes className="text-destructive text-sm" />
                                  )}
                                ...
                                {selectedQuestion === question.id ? (
                                  <FaChevronUp className="text-muted-foreground text-sm" />
                                ) : (
                                ...
                                >
                                  ...
                                  <div className="space-y-2 mb-4">
                                    {question.options.map((option, optIndex) => (
                                      <div
                                        key={optIndex}
                                        className={`p-2 rounded border text-sm ${optIndex === question.correctAnswer
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between mt-6">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-foreground bg-card border border-border rounded-lg hover:bg-secondary/50 disabled:opacity-50 disabled:cursor-not-allowed"
          >
